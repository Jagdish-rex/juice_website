...
// TweenMax.from('.home__leaf:nth-child(1)', 2, {delay: 1.4, opacity: 0, y: -800, ease: Expo.easeInOut})
// TweenMax.from('.home__leaf:nth-child(1)', 2, {delay: 1.5, opacity: 0, y: -800, ease: Expo.easeInOut})
// TweenMax.from('.home__leaf:nth-child(1)', 2, {delay: 1.6, opacity: 0, y: -800, ease: Expo.easeInOut})
// TweenMax.from('.home__leaf:nth-child(1)', 2, {delay: 1.7, opacity: 0, y: -800, ease: Expo.easeInOut})
// TweenMax.from('.home__leaf:nth-child(1)', 2, {delay: 1.8, opacity: 0, y: -800, ease: Expo.easeInOut})
